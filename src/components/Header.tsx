...
const Header = () => {
    ...
    return (
        ...
        >
            ...
            {/* Main nav bar */}
            <div className="absolute top-full left-0 w-full bg-dark/60 border-b border-white/10 py-3">
                <div className="w-full mx-auto px-4 2xl:px-[80px] flex lg:grid lg:grid-cols-[1fr_auto_1fr] items-center justify-between gap-4">


                    {/* Desktop navigation */}
                    <nav className="hidden lg:flex items-center gap-8 text-sm font-medium justify-self-start text-white">
                        {/* Home with dropdown */}
                        ...
                        <div className="group static">
                            ...
                            <div className="invisible opacity-0 group-hover:visible group-hover:opacity-100 group-hover:translate-y-1 transition-all duration-150 absolute left-0 w-full mt-3 bg-white text-[#111111] shadow-2xl py-8 px-12 grid grid-cols-5 z-40">
                                {/* Col 01 */}
                        ...
                        <div className="relative group">
                            ...
                            <div className="invisible opacity-0 group-hover:visible group-hover:opacity-100 group-hover:translate-y-1 transition-all duration-150 absolute -left-[100px] mt-3 bg-white text-[#111111] rounded shadow-2xl py-8 px-8 grid grid-cols-3 min-w-[750px] z-40">
                                {/* Col 01 */}
                                <div className="border-r border-gray-200 px-4">
                                    <div className="flex flex-col gap-3 text-sm text-gray-600">
                                        <Link
